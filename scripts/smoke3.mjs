...
fs.writeFileSync(path.join(userData, 'pomodoro-data.json'), JSON.stringify({
  ...
  pomodoros: [
    { id: 'p1', startedAt: '2026-06-09T01:00:00Z', endedAt: '2026-06-09T01:25:00Z', durationSec: 1500, completed: true, taskIds: ['t1', 't2'],
...
for (const f of ['json', 'csv-pomodoros', 'csv-tasks']) {
